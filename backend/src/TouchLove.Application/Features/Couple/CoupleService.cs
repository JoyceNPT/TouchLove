...
public class CoupleService
{
    ...
    public async Task<ApiResponse<CouplePageDto>> GetCouplePageAsync(Guid coupleId, CancellationToken ct = default)
    {
        ...
        var dto = new CouplePageDto(
            ...
            AvatarAUrl: couple.AvatarAUrl ?? couple.KeychainA?.User?.AvatarUrl,
            AvatarBUrl: couple.AvatarBUrl ?? couple.KeychainB?.User?.AvatarUrl,
            ...
            PartnerADisplayName: couple.KeychainA?.User?.DisplayName,
            PartnerBDisplayName: couple.KeychainB?.User?.DisplayName,
...
public record CouplePageDto(
    ...
    string? PartnerADisplayName, string? PartnerBDisplayName,
    string TodayMessage,
